...
//		ParseObject locationUpdate = new ParseObject("Breadcrumb");
//		locationUpdate.put("posLat", lastLocation.getLatitude());
//		locationUpdate.put("posLong", lastLocation.getLongitude());
//		locationUpdate.put("timestamp", System.currentTimeMillis());
//		locationUpdate.put("userId", (int)(Math.random() * 10));
//		locationUpdate.saveInBackground();
		...
		params.put("timestamp", (double) System.currentTimeMillis());
		params.put("userId", (double)(int)(Math.random() * 10));
